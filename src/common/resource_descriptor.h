#ifndef BATTLE_ROOM_RESOURCE_DESCRIPTOR_H
#define BATTLE_ROOM_RESOURCE_DESCRIPTOR_H
 ...
 */
    ...
    public:
        ...
        static std::string toJson(const ResourceDescriptor& settings);
...
#endif // BATTLE_ROOM_RESOURCE_DESCRIPTOR_H
